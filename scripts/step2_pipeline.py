...
from pipeline_schema import STEP2_CANDIDATE_COLUMNS
...
def setup():
 ...
 write_tsv(OUT/'candidates.tsv',STEP2_CANDIDATE_COLUMNS,((i,r['kmer_id'],r['canonical_kmer'],r['reverse_complement'],int(r['selection_reason'] in ('pooled','pooled_and_hap')),int(r['selection_reason'] in ('pooled','pooled_and_hap') and int(r['qualifying_haps'])>=broad_min)) for i,r in enumerate(src)))
